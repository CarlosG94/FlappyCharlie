...
function titleTransitionDown()
	downTransition = transition.to(titleGroup,{time=400, y=titleGroup.y+60,onComplete=titleTransitionUp})
...
function titleTransitionUp()
	...
	if titleGroup.y == display.contentCenterY + 250 then
		upTransition = transition.to(titleGroup,{time=400, y=titleGroup.y-500, onComplete=titleTransitionDown})
	end
end
